...
public class CommentProcessorRegistry {
    ...
    /**
     * Finds all processor expressions within the specified paragraph and tries to evaluate it against all
     * registered {@link ICommentProcessor}s.
     *
    ...
    private <T> void runProcessorsOnInlineContent(T contextRoot, ParagraphCoordinates paragraphCoordinates) {
        ...
        for (String processorExpression : processorExpressions) {
            ...
            // processor expression could not be processed by any processor -> throw the latest exception
    ...
    /**
     * Takes the first comment on the specified paragraph and tries to evaluate the string within the comment against all
     * registered {@link ICommentProcessor}s.
     *
    ...
    private <T> void runProcessorsOnParagraphComment(final WordprocessingMLPackage document,
        ...
        // comment could not be processed by any processor -> throw the latest exception
        if (failOnInvalidExpression && !expressionResolvedSuccessfully) {
