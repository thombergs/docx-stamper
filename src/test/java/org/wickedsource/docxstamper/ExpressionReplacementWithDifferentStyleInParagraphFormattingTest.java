...
public class ExpressionReplacementWithDifferentStyleInParagraphFormattingTest extends AbstractDocx4jTest {
    ...
    public void test() throws Docx4JException, IOException {
        ...
        InputStream template = getClass().getResourceAsStream("ExpressionReplacementWithDifferentStyleInParagraphFormattingTest.docx");
        ...
        assertBoldStyle((R) ((P) document.getMainDocumentPart().getContent().get(4)).getContent().get(1));
        assertItalicStyle((R) ((P) document.getMainDocumentPart().getContent().get(4)).getContent().get(3));
    }
